...
bool Adafruit_PN532::getAck(void) {
  pn532_packetbuffer[0] = PN532_COMMAND_GETFIRMWAREVERSION;

  return sendCommandCheckAck(pn532_packetbuffer, 1);
}

/**************************************************************************/
/*!
	Sets the RF byte of the RFConfiguration register for RF field off

	@returns 1 if everything executed properly, 0 for an error
*/
/**************************************************************************/
bool Adafruit_PN532::SetFieldOff() 
{
	pn532_packetbuffer[0] = PN532_COMMAND_RFCONFIGURATION;
...
/**************************************************************************/
/*!
	Sets the RF byte of the RFConfiguration register for RF field on

	@returns 1 if everything executed properly, 0 for an error
*/
/**************************************************************************/
bool Adafruit_PN532::SetFieldOn() 
{
	pn532_packetbuffer[0] = PN532_COMMAND_RFCONFIGURATION;
	pn532_packetbuffer[1] = 0x01;
